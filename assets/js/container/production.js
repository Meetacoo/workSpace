...
var productionConfig = {
    ...
    config: [{
        ...
        src: 'wp-content/themes/difu-web/assetsimg/production/about-icon-1.png',
        label: '聚合支付',
        value: '实现全渠道支付接入，也可以在已有支付方式上叠加其他支付通道，延伸原有机具业务场景，快速实现全渠道支付'
    }, {
        href: '#',
        src: 'wp-content/themes/difu-web/assetsimg/production/about-icon-2.png',
        label: '互联网支付',
...
// banner
var bannerConfig = {
    src: 'wp-content/themes/difu-web/assetsimg/bg-img/bg_21.jpg',
    title: '产品介绍',
...
var productionLinkConfig = {
    linkTo: 'wp-content/themes/difu-web/pricing.php',
    title: '想了解更多产品？',
    button: '查看产品定价',
