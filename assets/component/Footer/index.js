...
function FooterListItemProductInnerHtml(dataSource) {
    ...
    for (var i = 0; i < dataSource.length; i++) {
        ...
        Default_InnerHtml += '<div class="single-latest-news-area d-flex align-items-center">\n' +
            ...
            '                            <img src="wp-content/themes/difu-web/assetsimg/bg-img/8.jpg" alt="">\n' +
            '                        </div>\n' +
            '                        <div class="news-content">\n' +
            '                            <a href="' + href + '">' + dataSource[i].subtitle + '</a>\n' +
            '                            <div class="news-meta">\n' +
            '                                <a href="#" class="post-date"><img src="wp-content/themes/difu-web/assetsimg/core-img/pencil.png" alt="">' + dataSource[i].description + '</a>\n' +
            '                            </div>\n' +
            '                        </div>\n' +
            '                    </div>';
    }
...
function footerInnerHtml(dataSource) {
    ...
    return '<footer class="footer-area section-padding-100-0">\n' +
        ...
        '                        <!-- Footer Logo -->\n' +
        '                        <a href="index.html" class="footer-logo"><img src="wp-content/themes/difu-web/assetsimg/core-img/logo.png" alt=""></a>\n' +
        '                        <!-- Copywrite Text -->\n' +
