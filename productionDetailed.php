...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri().'/assets/css/container/productionDetailed.css'; ?>">
            ...
            <div class="container wow fadeInUp">
                <div class="row fullscreen align-items-center ">
                    ...
                    <div class="col-lg-6 col-md-6 banner-right">
                        <h6>产品介绍</h6>
                        <h1>聚合支付传统POS收款</h1>
                        <p>传统终端的支付程序升级，实现刷卡的同时支持第三方电子钱包支付， 已适配市面上各大主流 POS 机型。</p>
                    </div>
                </div>
            </div>
        </section>
    </div>
    <section class="section stretch-section section-second-box">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Section Heading -->
            ...
            <div class="row align-items-center">
                <div class="col-md-6 stretch-left-1 element-animate" id="secondBox">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="media d-block media-feature text-center">
                                <span class="icon icon-profits"></span>
                                <div class="media-body">
                                    <h3 class="mt-0 text-black">满足多种支付方式</h3>
                                    <p>为你解决层出不穷的支付方式,可以实现扫码，刷卡，插卡，非接全部支付方式， 灵活满足你的付款需求.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="media d-block media-feature text-center">
                                <span class="icon icon-money-1"></span>
                                <div class="media-body">
                                    <h3 class="mt-0 text-black">覆盖多种行业</h3>
                                    <p>提供POS支付接入方案，可在各种场景中流畅交易,涵盖零售，金融，教育，医疗，电商，旅游等众多行业.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="media d-block media-feature text-center">
                                ...
                                <div class="media-body">
                                    <h3 class="mt-0 text-black">适配市面多种机型</h3>
                                    <p>无需换机，为你适配,适配了百富，华智融，新大陆，联迪，新国都五款市面主流POS机品牌.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="media d-block media-feature text-center">
                                ...
                                <div class="media-body">
                                    <h3 class="mt-0 text-black">全支付渠道</h3>
                                    <p>国际卡，银联，电子钱包。全世界都是你的客户,Visa、万事达、JCB、大莱、运通；银联、银联国际；微信、支付宝、翼支付、百度钱包.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="about-content mb-100">
                            ...
                            <div class="section-heading">
                                <div class="line"></div>
                                <p>integration payment</p>
                                <h2>聚合支付传统POS收款</h2>
                            </div>
                            <h6 class="mb-4">迪付（www.difu.com）创立于2015年，是全球领先的云计算及人工智能科技公司。</h6>
                            <p class="mb-0 paragraph">聚合支付传统 POS 收款是在传统银行卡收款架构上叠加移动支付收款服务。已适配市面上各大主流 POS
                                机型，是最全面的聚合支付解决方案。用户可根据自身需求选择 “all-in-one”
                                程序，实现全渠道支付接入；也可以在已有支付方式上叠加其他支付通道，延伸原有机具业务场景，快速实现全渠道支付。</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-10 col-lg-8">
                        <div class="nl-content text-center">
                            ...
                            <a href="http://localhost/wordpress/production">联系我们</a>
                            <p>Curabitur elit turpis, maximus quis ullamcorper sed, maximus eu neque. erat nec.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo get_template_directory_uri().'/assets/js/container/productionDetailed.js'; ?>"></script>
<!-- Popper js -->
